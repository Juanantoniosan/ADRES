...
namespace PruebaAdres.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(AdquisicionesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,NombreEntidad,TipoDocumento,NumeroDocumento")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,NombreEntidad,TipoDocumento,NumeroDocumento")] Proveedor proveedor)
        {
